...
namespace iTextSharp.text.pdf.parser
{
   ...
   public class snSimpleTextExtractionStrategy : ITextExtractionStrategy
    {
         ...
         */
        public snSimpleTextExtractionStrategy()
        {
        }

        public snSimpleTextExtractionStrategy(float linespacing , float spacing)
        {
            Spacing = spacing;
            ...
            else if (!firstRender)
            {
                ...
                { // we only insert a blank space if the trailing character of the previous string wasn't a space,
                   // and the leading character of the current string isn't a space
                    ...
                    if (spacing > renderInfo.GetSingleSpaceWidth() / Spacing)
                    {
                        AppendTextChunk(' ');
